...
const cards = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Backend:",
        detail: "Spring Boot, Next.js, MongoDB, PostgreSQL",
      },
  ...
  },
  {
    ...
    items: ["User-Centered Design", "Modern & Clean UI", "Responsive Layouts"],
  },
];
...
export function Skills({ onViewProjects }: Readonly<SkillsProps>) {
  return (
    <section
      id="projects"
      className="mx-auto w-full max-w-6xl px-4 pt-12 pb-6 sm:px-6"
    >
