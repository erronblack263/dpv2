...
export function Hero() {
  return (
    <section
      id="home"
      className="relative flex min-h-[calc(78vh-4rem)] items-center pt-16 sm:min-h-[calc(100vh-4rem)] sm:pt-0"
    >
      <div className="mx-auto w-full max-w-5xl px-4 pb-4 sm:px-6 sm:pb-0">
        <div className="flex flex-col items-center gap-4 text-center sm:gap-8 lg:flex-row lg:items-center lg:text-left">
          <div className="relative shrink-0">
            ...
            <Image
              ...
              priority
              quality={100}
              className="relative size-40 rounded-full border-2 border-primary/40 object-cover sm:size-56"
            />
          </div>
