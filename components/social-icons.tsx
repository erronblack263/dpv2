...
export function GitLabIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="m23.6 9.59-.03-.08-3.27-8.53a.85.85 0 0 0-.84-.54.86.86 0 0 0-.49.19.86.86 0 0 0-.29.43l-2.2 6.75H7.53l-2.2-6.75a.85.85 0 0 0-.29-.43.86.86 0 0 0-.99-.01.86.86 0 0 0-.34.36L.43 9.5l-.03.08a6.07 6.07 0 0 0 2.01 7.01l.01.01.03.02 4.98 3.73 2.46 1.86 1.5 1.13a1 1 0 0 0 1.21 0l1.5-1.13 2.46-1.86 5.01-3.75.01-.01a6.07 6.07 0 0 0 2.01-7Z" />
    </svg>
  );
}
