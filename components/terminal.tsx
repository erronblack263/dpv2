...
const lines = [
  ...
  { type: "bullet" as const, text: "ReactJS" },
  { type: "bullet" as const, text: "NextJS" },
  { type: "bullet" as const, text: "TypeScript" },
  { type: "bullet" as const, text: "Python" },
  { type: "bullet" as const, text: "React Native" },
  { type: "prompt" as const, text: "status" },
  { type: "output" as const, text: "Currently working on scalable and secure software solutions" },
  { type: "prompt" as const, text: "mission" },
  { type: "output" as const, text: "Making an impact every day in the lives of the community 🚀" },
