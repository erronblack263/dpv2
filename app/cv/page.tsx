        ...
        <div className="mt-10 grid items-start gap-10 lg:grid-cols-[0.7fr_1.3fr]">
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-md bg-white shadow-sm">
              <img
                src={CV_PAGE_URLS[0]}
                alt="Witness H Musonza CV page 1"
                className="block h-[min(72vh,820px)] w-full object-cover object-top select-none"
                draggable={false}
                onContextMenu={blockDocumentSaving}
              />
              <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-white via-white/80 to-transparent backdrop-blur-[2px]"
              />
              <button
                type="button"
                onClick={() => openPage(0)}
                className="absolute bottom-5 left-1/2 z-10 inline-flex -translate-x-1/2 items-center gap-2 rounded-full bg-violet-600 px-5 py-2.5 text-xs font-semibold text-white shadow-[0_0_24px_rgba(124,58,237,0.45)] transition-all hover:bg-violet-500"
              >
