...
export default function HeroLandingClient() {
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-12 lg:px-20">
        ...
        <div className="relative w-full px-4 sm:px-8 lg:px-16 pb-0">
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(168,85,247,0.8), rgba(124,58,237,0.4), rgba(168,85,247,0.8))",
              boxShadow:
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 80% 60% at 50% 50%, rgba(168,85,247,0.12) 0%, transparent 70%)",
              filter: "blur(24px)",
            }}
          />
        </div>
