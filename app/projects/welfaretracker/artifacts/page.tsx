    ...
    <>
      <section className="mx-auto w-full max-w-6xl px-4 pt-12 pb-24 sm:px-6">
        ...
        <div className="mb-10 flex items-start gap-4">
          ...
          <div>
            <h1 className="text-3xl font-extrabold tracking-tight sm:text-4xl">WelfareTracker — Project Artifacts</h1>
            <p className="mt-2 text-muted-foreground">Screenshots and design artifacts from the WelfareTracker platform. Tap any image to view full size.</p>
          </div>
        </div>
        ...
        {sections.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-border py-24 text-center">
            ...
            <p className="mt-2 max-w-sm text-sm text-muted-foreground">
              Add screenshots to{' '}
              <code className="rounded bg-muted px-1 py-0.5 text-xs">/public/artifacts/welfaretracker/</code>{' '}
