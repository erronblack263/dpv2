  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-sky-500/30 selection:text-sky-500 font-sans pb-16 transition-colors duration-300">
      <Link
        ...
        className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 inline-flex items-center gap-1.5 rounded-full bg-sky-600 px-3.5 py-2 text-xs font-bold text-white shadow-[0_6px_18px_rgba(2,132,199,0.3)] transition-all hover:-translate-y-0.5 hover:bg-sky-500 hover:shadow-[0_8px_22px_rgba(2,132,199,0.4)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      >
