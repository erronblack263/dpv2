...
const DEMO_FRAMES: readonly DemoFrame[] = [
  {
    ...
    video:
      "https://res.cloudinary.com/virfpzu4/video/upload/v1787568897/1.intro_lia72w.mp4",
  },
  {
    ...
    video:
      "https://res.cloudinary.com/virfpzu4/video/upload/v1787568940/2.authentication_kaipha.mp4",
  },
  {
    title: "Products Page",
    category: "Products",
    ...
    video:
      "https://res.cloudinary.com/virfpzu4/video/upload/v1787568915/3.products_CRUD_kd5gyy.mp4",
  },
  {
    ...
    video:
      "https://res.cloudinary.com/virfpzu4/video/upload/v1787568933/4.categories_CRUD_wedhck.mp4",
  },
  {
    ...
    video:
      "https://res.cloudinary.com/virfpzu4/video/upload/v1787568931/5.customers_CRUD_nbelp2.mp4",
  },
  {
    ...
    video:
      "https://res.cloudinary.com/virfpzu4/video/upload/v1787568901/6.user_management_CRUD_awx9qj.mp4",
  },
  {
    title: "Orders Page",
    category: "Orders",
    ...
    video:
      "https://res.cloudinary.com/virfpzu4/video/upload/v1787568928/7.orders_CRUD_vtgyym.mp4",
  },
  {
    ...
    video:
      "https://res.cloudinary.com/virfpzu4/video/upload/v1787568942/8.search_update_operations_io7ihc.mp4",
  },
  {
    ...
    video:
      "https://res.cloudinary.com/virfpzu4/video/upload/v1787568934/9.delete_operations_b7ggnf.mp4",
  },
  {
    title: "Outro & Summary",
    category: "Summary",
    ...
    video:
      "https://res.cloudinary.com/virfpzu4/video/upload/v1787568867/10.outro_plus_final_exp_ds8cr1.mp4",
  },
];
...
export default function InventoryManagementDemoPage() {
  const [activeCategory, setActiveCategory] =
    useState<DemoCategory>("All demos");
      ...
      <div className="mx-auto max-w-7xl px-5 pt-3 sm:px-8 lg:px-12">
        ...
        >
          ...
          <span className="font-medium text-foreground">
            Reda Inventory Management System
          </span>
        </nav>
        ...
        <div className="grid items-start gap-5 lg:grid-cols-12">
          <section data-demo-details className="relative lg:col-span-4">
            ...
            <div className="relative z-10">
              ...
              <p className="mt-5 text-[10px] font-bold uppercase tracking-[0.18em] text-orange-500">
                SAGE · VIDEO DEMO
              </p>
              ...
              <p className="mt-4 max-w-md text-sm leading-relaxed text-muted-foreground">
                A C# inventory management system backed by MySQL Server for
                organizing products, tracking stock records, and keeping daily
                operations clear.
              </p>
              <div className="mt-5 flex flex-wrap gap-1.5">
                <span className="inline-flex items-center gap-1 rounded-full border border-orange-500/40 bg-orange-500/10 px-2.5 py-1 text-[10px] font-semibold text-orange-500">
                  <Database className="size-3" /> Full CRUD
                </span>
                <span className="inline-flex items-center gap-1 rounded-full border border-amber-500/40 bg-amber-500/10 px-2.5 py-1 text-[10px] font-semibold text-amber-500">
                  <Database className="size-3" /> MySQL Server
                </span>
              </div>
            </div>
          </section>
          ...
          <section className="flex flex-col gap-2 lg:col-span-5">
            <div
              data-demo-video
              className="relative flex aspect-video w-full items-center justify-center overflow-hidden rounded-xl border border-orange-500/25 bg-zinc-950 shadow-[0_0_40px_rgba(249,115,22,0.16)]"
            >
              <VideoPlayer
                key={frame.video}
                src={streamUrl(frame.video)}
                thumbnail={cloudinaryThumb(frame.video)}
                title={frame.title}
              />
            </div>
            <div
            ...
            >
              ...
              <div className="flex shrink-0 items-center gap-1.5">
                ...
                <button
                  ...
                  className="rounded-md border border-orange-500/30 bg-orange-500/10 p-1 text-orange-500 hover:bg-orange-500/20"
          ...
          >
            <div className="rounded-xl border border-border bg-card p-4 shadow-xl">
              ...
              <div className="flex flex-col gap-3 text-[11px] text-muted-foreground">
                {PROJECT_DETAILS.map(({ label, value, icon: Icon }) => (
            ...
            >
              ...
              <p className="mt-2 text-[11px] leading-relaxed text-muted-foreground">
                View the inventory system project page and implementation
                details.
              </p>
            </Link>
          </aside>
          ...
          {CATEGORIES.map((category, index) => {
            ...
            return (
              <div key={category} className="flex shrink-0 items-center">
                ...
                >
                  <span
                    className={`flex size-8 items-center justify-center rounded-full border-2 text-[10px] font-bold transition-all ${isActive ? "border-orange-500 bg-orange-500 text-zinc-950 shadow-[0_0_12px_rgba(249,115,22,0.4)]" : "border-border bg-muted text-muted-foreground group-hover:border-orange-500/60 group-hover:text-orange-500"}`}
                  >
                    {index + 1}
                  </span>
                  <span
                    className={`whitespace-nowrap text-[10px] font-semibold ${isActive ? "text-orange-500" : "text-muted-foreground group-hover:text-foreground"}`}
                  >
                    {category}
                  </span>
                </button>
                {index < CATEGORIES.length - 1 && (
                  <span className="mx-2 mb-4 h-0.5 w-6 rounded-full bg-border sm:w-10" />
                )}
              </div>
            );
          })}
        ...
        <section className="mt-5 rounded-xl border border-border bg-card/60 p-3.5 backdrop-blur-md sm:p-4">
          <div className="mb-3 flex items-center justify-between">
            <h2 className="text-[10px] font-bold uppercase tracking-[0.18em] text-orange-500">
              Video demos
            </h2>
              ...
              {previewPageCount > 1 && (
                <span className="flex items-center gap-1.5 border-l border-border pl-2">
                  <button
                    ...
                    className="flex size-6 items-center justify-center rounded-md border border-orange-500/30 text-orange-500 transition-colors hover:bg-orange-500/10 disabled:pointer-events-none disabled:opacity-30"
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            {visibleFrames.map((demoFrame, index) => {
              const frameIndex = previewPage * previewPageSize + index;
              return (
                <button
                  ...
                  className={`group relative overflow-hidden rounded-xl border p-2 text-left transition-all ${frameIndex === activeFrame ? "border-orange-500 bg-orange-500/10 shadow-[0_0_20px_rgba(249,115,22,0.18)]" : "border-border bg-background/50 hover:border-orange-500/40"}`}
                >
                  <div className="relative aspect-video overflow-hidden rounded-lg bg-zinc-950">
                    <Image
                      src={cloudinaryThumb(demoFrame.video)}
                      alt={demoFrame.title}
                      fill
                      quality={65}
                    ...
                    <span className="absolute left-2 top-2 rounded-md bg-zinc-950/75 px-1.5 py-0.5 font-mono text-[9px] text-white">
                      {String(frameIndex + 1).padStart(2, "0")}
                    </span>
                    <span className="absolute bottom-2 right-2 rounded-md bg-orange-400 px-1.5 py-0.5 text-[9px] font-bold text-zinc-950">
                      VIDEO
                    </span>
                  </div>
                  ...
                  <span className="mt-1 inline-flex w-fit rounded-full border border-orange-500/25 bg-orange-500/10 px-2 py-0.5 text-[9px] font-semibold text-orange-500">
                    {demoFrame.category}
                  </span>
                </button>
              );
            ...
            {[
              {
                title: "Create",
                description:
                  "Add products, categories, customers, users, and orders.",
                icon: Package,
              },
              {
                title: "Read",
                description: "Search and review records across the system.",
                icon: Search,
              },
              {
                title: "Update",
                description:
                  "Edit product and account data as operations change.",
                icon: Database,
              },
              {
                title: "Delete",
              ...
              <div key={title} className="flex items-start gap-2.5">
                <span className="flex size-7 shrink-0 items-center justify-center rounded-full bg-orange-400 text-zinc-950">
        ...
        <div className="mt-5 flex items-center gap-2 border-t border-border pt-4 text-[11px] text-muted-foreground">
          <ShieldCheck className="size-4 text-orange-500" /> Ten guided
          recordings covering the complete C# and MySQL Server inventory
          workflow.
        </div>
      </div>
    </div>
